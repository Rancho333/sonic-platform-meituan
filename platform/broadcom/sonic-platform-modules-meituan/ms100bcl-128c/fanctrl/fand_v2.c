...
#define SYS_FAN_LED_PATH "/sys/bus/i2c/drivers/syscpld/142-000d/fan_led_ctrl_en"
...
#define THERMAL_DIR_F2B_STR "R3075-F0001-01"
...
#define FAN_WDT_ENABLE_SYSFS "/sys/bus/i2c/drivers/fancpld/138-000d/wdt_en"
#define FAN_WDT_TIME_SYSFS "/sys/bus/i2c/drivers/fancpld/138-000d/wdt_time"
#define PSU1_SHUTDOWN_SYSFS "/sys/bus/i2c/drivers/dps1100/158-0058/control/shutdown"
#define PSU2_SHUTDOWN_SYSFS "/sys/bus/i2c/drivers/dps1100/159-0058/control/shutdown"
#define PSU3_SHUTDOWN_SYSFS "/sys/bus/i2c/drivers/dps1100/160-0058/control/shutdown"
#define PSU4_SHUTDOWN_SYSFS "/sys/bus/i2c/drivers/dps1100/161-0058/control/shutdown"
#define PSU_SPEED_CTRL_NODE "fan1_cfg"
#define PSU_SPEED_CTRL_ENABLE 0x90

#define PID_CONFIG_PATH "/usr/local/etc/pid_config_ms100bcl-128c.ini"
...
const char *fan_eeprom_path[] =
{
    ...
    "/sys/bus/i2c/devices/5-0050/eeprom",
    "/sys/bus/i2c/devices/6-0050/eeprom",
    /* PSU EEPROM */
    "/sys/bus/i2c/devices/158-0050/eeprom",
    "/sys/bus/i2c/devices/159-0050/eeprom",
    "/sys/bus/i2c/devices/160-0050/eeprom",
    "/sys/bus/i2c/devices/161-0050/eeprom",
    "/sys/bus/i2c/devices/162-0050/eeprom",
    "/sys/bus/i2c/devices/163-0050/eeprom",
};
static struct sensor_info_sysfs linecard1_onboard_u25 = {
  .prefix = "/sys/bus/i2c/drivers/lm75/150-0049",
  .suffix = "temp1_input",
  .error_cnt = 0,
  .temp = 0,
  .t1 = 0,
...
static struct sensor_info_sysfs linecard1_onboard_u26 = {
  .prefix = "/sys/bus/i2c/drivers/lm75/150-0048",
  .suffix = "temp1_input",
  .error_cnt = 0,
  .temp = 0,
  .t1 = 0,
...
static struct sensor_info_sysfs linecard2_onboard_u25 = {
  .prefix = "/sys/bus/i2c/drivers/lm75/151-0049",
  .suffix = "temp1_input",
  .error_cnt = 0,
  .temp = 0,
  .t1 = 0,
...
static struct sensor_info_sysfs linecard2_onboard_u26 = {
  .prefix = "/sys/bus/i2c/drivers/lm75/151-0048",
  .suffix = "temp1_input",
  .error_cnt = 0,
  .temp = 0,
  .t1 = 0,
...
static struct sensor_info_sysfs switchboard_onboard_u33 = {
  .prefix = "/sys/bus/i2c/drivers/lm75/139-004d",
  .suffix = "temp1_input",
  .error_cnt = 0,
  .temp = 0,
  .t1 = 0,
...
static struct sensor_info_sysfs switchboard_onboard_u148 = {
  .prefix = "/sys/bus/i2c/drivers/max31730/139-004c",
  .suffix = "temp3_input",
  .error_cnt = 0,
  .temp = 0,
  .t1 = 0,
...
static struct sensor_info_sysfs switchboard_inlet_sensor = {
  .prefix = "/sys/bus/i2c/devices/i2c-142/142-000d",
  .suffix = "temp1_input",
  .error_cnt = 0,
  .temp = 0,
  .t1 = 0,
...
static struct sensor_info_sysfs baseboard_onboard_u3 = {
  .prefix = "/sys/bus/i2c/drivers/lm75/139-004e",
  .suffix = "temp1_input",
  .error_cnt = 0,
  .temp = 0,
  .t1 = 0,
...
static struct sensor_info_sysfs baseboard_onboard_u41 = {
  .prefix = "/sys/bus/i2c/drivers/lm75/139-004f",
  .suffix = "temp1_input",
  .error_cnt = 0,
  .temp = 0,
  .t1 = 0,
...
static struct sensor_info_sysfs pdbboard_onboard_u8 = {
  .prefix = "/sys/bus/i2c/drivers/lm75/165-0048",
  .suffix = "temp1_input",
  .error_cnt = 0,
  .temp = 0,
  .t1 = 0,
...
static struct sensor_info_sysfs pdbboard_onboard_u10 = {
  .prefix = "/sys/bus/i2c/drivers/lm75/165-0049",
  .suffix = "temp1_input",
  .error_cnt = 0,
  .temp = 0,
  .t1 = 0,
...
static struct sensor_info_sysfs fcbboard_onboard_u10 = {
  .prefix = "/sys/bus/i2c/drivers/lm75/9-0049",
  .suffix = "temp1_input",
  .error_cnt = 0,
  .temp = 0,
  .t1 = 0,
...
static struct sensor_info_sysfs sensor_cpu_inlet_critical_info = {
  .prefix = "/sys/bus/platform/drivers/coretemp/coretemp.0/hwmon/hwmon0",
  .suffix = "temp1_input",
  .error_cnt = 0,
  .temp = 0,
  .t1 = 0,
...
{
    .prefix = "/sys/bus/i2c/drivers/fancpld/138-000d",
...
static struct fan_info_stu_sysfs psu2_fan_info =
{
    .prefix = "/sys/bus/i2c/drivers/syscpld/142-000d",
    .front_fan_prefix = "fan1_input",
    .rear_fan_prefix = "/sys/bus/i2c/drivers/dps1100/160-0058",
    .pwm_prefix = "fan1_pct",
    .fan_led_prefix = "psu_led_ctrl_en",
...
static int read_fan_led(const int fan);
...
static int read_fan_led(const int fan)
{
    ...
    * or this function already returned -1. So assume the cache is always on
    */
    ret = read_sysfs_int(fullpath, &value);
    if (ret < 0)
    {
        syslog(LOG_ERR, "failed to get fan %s/%s",
               fan_info->prefix, fan_info->fan_led_prefix);
        return -1;
    }
...
static int get_fan_direction(int direction)
{
    ...
    for (; i < TOTAL_FANS + TOTAL_PSUS; i++)
    {
        if (i >= sizeof(fan_eeprom_path) / sizeof(fan_eeprom_path[0]))
            continue;
        fantray = &fantray_info[i];
        if ((!fantray->read_eeprom) && (fantray->direction != FAN_DIR_FAULT))
            continue;
        if (!fantray->status)
            continue;
...
int get_thermal_direction(void)
{
    ...
    sprintf(command, "decode-syseeprom | grep 'Part Number' 2> /dev/null");
    fp = popen(command, "r");
    ...
    while (1)
    {
        ...
        for (fan = 0; fan < TOTAL_FANS; fan++)
        {
            ...
            */
            ...
            {
                if (read_fan_led(fan) == FAN_LED_RED)
                {
